...
# %% [markdown]
# This dataset contains techno-economic data on Fischer-Tropsch synthesis plants.
...
units = {
    ...
    "Output Capacity|Fischer-Tropsch Fuel": "kW",
    "Output|Fischer-Tropsch Fuel": "MWh",
}
