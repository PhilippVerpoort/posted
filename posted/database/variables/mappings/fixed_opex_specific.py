...
class FixedOPEXSpecificMapper(AbstractVariableMapper):
    ...
    def _map(self, df: pd.DataFrame, cond: pd.Series) -> pd.DataFrame:
        ...
        # Apply all.
        df.loc[cond, "variable"] = "OPEX Fixed"
        df.loc[cond, "reference_variable"] = new_ref_var
        df.loc[cond, "value"] *= (
