...
from .fields import (
    AbstractColumnDefinition as AbstractColumnDefinition,
)
from .fields import (
...
base_columns = (
    ["source"] + list(base_columns_src_detail) + list(base_columns_other)
)


def _read_fields_comments(
    columns: dict,
) -> tuple[
