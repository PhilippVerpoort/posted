...
# %% [markdown]
# # Haber-Bosch with Reforming

# %% [markdown]
# This dataset contains techno-economic data on Haber-Bosch synthesis plants with an methane reformer.
...
var = "Tech|Haber-Bosch with Reforming"
