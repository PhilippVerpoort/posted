...
-   :material-file-code:{ .lg .middle } __API Reference__
    ...
    [:octicons-arrow-right-24: Read the code docs](api.md)
...
The software code located in `posted/` in the repository is licensed under an [MIT Licence](https://github.com/PhilippVerpoort/posted/blob/main/LICENSE.md).

The data located in `posted/database/` in the repository is licensed under a [CC-BY-4.0](https://github.com/PhilippVerpoort/posted/blob/main/posted/database/LICENSE.md).
