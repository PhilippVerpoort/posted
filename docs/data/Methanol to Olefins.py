...
# %% [markdown]
# This dataset contains techno-economic data on Methanol-to-Olefin plants.
...
units = {
    ...
    "Output|Ethylene": "t",
    "Output Capacity|Ethylene": "t/year",
}
...
aggregated = tedf.aggregate(
    ...
    reference_activity="Output|Ethylene",
    reference_capacity="Output Capacity|Ethylene",
)
